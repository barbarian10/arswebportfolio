                        ...
                        <Box alignSelf={'center'} textAlign='left'>
                            <HStack spacing={4} boxShadow='md' p='4' rounded='md' bg={boxBG}>
                                ...
                                <Stack spacing={0}>
                                    ...
                                    <Link href='arslanbektemir1@gmail.com' color='blue.500' fontWeight='medium'>arslanbektemir1@gmail.com</Link>
                                </Stack>
                            </HStack>
                            <Stack display={{ base: 'none', md: 'flex' }}>
                                <Box className={styles.tiltBox2} width={250}>
                                    <Text className={styles.customFont} color={scribbleColor[2]}>
                                        Don&apos;t be a stranger, hit me up on any of my socials to connect.
                                    </Text>
                                </Box>
                                <Box className={styles.tiltArrow2}>
                                    <Image src={arrow} alt='arrow pointing to content' width={100} height={100} />
                                </Box>
                            </Stack>
                        </Box>

            ...
            <SimpleGrid columns={{ base: 3, md: 5 }} spacing={3}>
                {techStack.map((s: TechStack) =>
                    <Button
                        ...
                        key={s.label}
                        variant='outline'
                        leftIcon={s.label === 'NextJS' ? <SiNextdotjs /> : <Image src={s.logo} alt={`${s.label} logo`} height={16} width={16} />}>
                        {s.label}
                    </Button>
                )}
            </SimpleGrid>
            ...
            <SimpleGrid columns={{ base: 3, md: 5 }} spacing={3}>
                {myassetbuddyTechStack.map((s: TechStack) =>
                    <Button
                        ...
                        key={s.label}
                        variant='outline'
                        leftIcon={<Image src={s.logo} alt={`${s.label} logo`} height={18} width={18}  />}>
                        {s.label}
                    </Button>
                )}
            </SimpleGrid>
            ...
            <SimpleGrid columns={{ base: 3, md: 5 }} spacing={3}>
                {niceTechStack.map((s: TechStack) =>
                    <Button
                        ...
                        variant='outline'
                        leftIcon={
                            s.label === 'Bash' ? <Image src={s.logo} alt={`${s.label} logo`} height={25}  width={25}  /> :
                                <Image src={s.logo} alt={`${s.label} logo`} height={16}  width={16}  />
                        }>
                        {s.label}
                    </Button>
                )}
            ...
            <SimpleGrid columns={{ base: 3, md: 5 }} spacing={3}>
                {medBuyerTechStack.map((s: TechStack) =>
                    <Button
                        ...
                        key={s.label}
                        variant='outline'
                        leftIcon={<Image src={s.logo} alt={`${s.label} logo`} height={16}  width={16}  />}>
                        {s.label}
                    </Button>
                )}
            </SimpleGrid>
